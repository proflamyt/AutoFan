...
void setup()
{
    ...
    // Pin mode for Input: room_temperature
    dht.begin();
    //remove
    Serial.begin(9600);
...
void loop()
{
    // Read Input: room_temperature
    float t = dht.readTemperature();
    //remove
    Serial.println(t);
    if (isnan(t) || t < 35 || t > 38) {
      //remove
...
FIS_TYPE fis_gMFI0Coeff1[] = { 34.94, 35.82, 36.46 };
FIS_TYPE fis_gMFI0Coeff2[] = { 36.44, 36.9, 36.92 };
FIS_TYPE fis_gMFI0Coeff3[] = { 36.92, 37.91, 38.88 };
FIS_TYPE* fis_gMFI0Coeff[] = { fis_gMFI0Coeff1, fis_gMFI0Coeff2, fis_gMFI0Coeff3 };
FIS_TYPE** fis_gMFICoeff[] = { fis_gMFI0Coeff };

// Coefficients for the Output Member Functions
FIS_TYPE fis_gMFO0Coeff1[] = { -102, 0, 113.670634920635 };
FIS_TYPE fis_gMFO0Coeff2[] = { 95.1, 112, 206.09126984127 };
...
// Input range Min
FIS_TYPE fis_gIMin[] = { 35.8 };

// Input range Max
FIS_TYPE fis_gIMax[] = { 38 };
